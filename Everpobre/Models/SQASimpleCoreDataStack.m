...
#import "SQASimpleCoreDataStack.h"

@interface SQASimpleCoreDataStack ()
...
@implementation SQASimpleCoreDataStack
    ...
    if (_storeCoordinator == nil) {
        ...
        if (![_storeCoordinator addPersistentStoreWithType:NSSQLiteStoreType
            ...
            NSNotification *note = [NSNotification
                                    notificationWithName:[SQASimpleCoreDataStack persistentStoreCoordinatorErrorNotificationName]
                                    object:self
                                    userInfo:@{@"error" : err}];
...
+ (SQASimpleCoreDataStack *)coreDataStackWithModelName:(NSString *)aModelName databaseFilename:(NSString*) aDBName
{
    NSURL *url = nil;
...
+ (SQASimpleCoreDataStack *)coreDataStackWithModelName:(NSString *)aModelName
{
    return [self coreDataStackWithModelName:aModelName databaseFilename:nil];
}

+ (SQASimpleCoreDataStack *)coreDataStackWithModelName:(NSString *)aModelName databaseURL:(NSURL *)aDBURL
{
